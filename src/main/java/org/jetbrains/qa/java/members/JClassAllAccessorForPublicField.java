...
public class JClassAllAccessorForPublicField {
    public int publicGetterSetter = 0;
    public int protectedGetterSetter = 0;
    public int defaultGetterSetter = 0;
    public int privateGetterSetter = 0;
