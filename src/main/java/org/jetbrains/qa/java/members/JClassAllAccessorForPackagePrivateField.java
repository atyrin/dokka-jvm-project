...
public class JClassAllAccessorForPackagePrivateField {
    int publicGetterSetter = 0;
    int protectedGetterSetter = 0;
    int defaultGetterSetter = 0;
    int privateGetterSetter = 0;
